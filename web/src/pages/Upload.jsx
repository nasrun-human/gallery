        ...
        try {
            ...
            if (err.response) {
                if (err.response.status === 401) {
                    ...
                    setError('เกิดข้อผิดพลาดในการอัพโหลด: ' + (err.response.data?.error || 'กรุณาลองใหม่อีกครั้ง'));
                }
            } else if (err.request) {
                ...
                <form onSubmit={handleUpload} className="p-6 space-y-6">
                    ...
                    <div className="pt-4">
                        <button
                            ...
                            className={`w-full py-3 px-4 rounded-lg text-white font-medium flex justify-center items-center gap-2 ${!file || uploading ? 'bg-gray-300 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 shadow-lg shadow-indigo-200'
                                }`}
                        >
